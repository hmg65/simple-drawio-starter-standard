(function () {
  ...
  Sidebar.prototype.allied_telesis = [
    "Buildings",
  ...
  Sidebar.prototype.gcp2 = [
    ...
    "Product Cards",
    "General Icons",
    "Icons AI Machine Learning",
    "Icons Compute",
    "Icons Data Analytics",
    "Icons Management Tools",
    "Icons Networking",
    "Icons Developer Tools",
  ...
  Sidebar.prototype.rack = [
    ...
    "F5",
    "HP",
    "HPE Aruba Gateways Controllers",
    "HPE Aruba Security",
    "HPE Aruba Switches",
    "IBM",
    "Oracle",
  ...
  Sidebar.prototype.configuration = [
    ...
    },
    {
      id: "ios",
      prefix: "ios",
      libs: ["" /*prefix is library*/, "7icons", "7ui"],
    },
    ...
    },
    {
      id: "clipart",
      prefix: null,
      libs: ["computer", "finance", "clipart", "networking", "people", "telco"],
    },
    { id: "ibm", prefix: "ibm", libs: Sidebar.prototype.ibm },
    {
      id: "allied_telesis",
      prefix: "allied_telesis",
      libs: Sidebar.prototype.allied_telesis,
    },
    ...
    { id: "rack", prefix: "rack", libs: Sidebar.prototype.rack },
    {
      id: "electrical",
      prefix: "electrical",
      libs: Sidebar.prototype.electrical,
    },
    ...
    { id: "cisco", prefix: "cisco", libs: Sidebar.prototype.cisco },
    {
      id: "cisco_safe",
      prefix: "cisco_safe",
      libs: Sidebar.prototype.cisco_safe,
    },
    ...
    { id: "gmdl", prefix: "gmdl", libs: Sidebar.prototype.gmdl },
    {
      id: "archimate3",
      prefix: "archimate3",
      libs: Sidebar.prototype.archimate3,
    },
  ...
  Sidebar.prototype.insertSearchHint = function (
    ...
    if (terms != null && page == 1) {
      ...
      if (hintText != null && !this.hideSearchHint) {
        ...
        link.style.cssText =
          "background-color:#ffd350;border-radius:6px;color:black;" +
  ...
  Sidebar.prototype.isEntryVisible = function (key) {
    ...
    if (config != null) {
      var id =
        config.libs != null ? (config.prefix || "") + config.libs[0] : key;
      var elts = this.palettes[id];
    ...
    this.entries = [
      {
        ...
        entries: [
          ...
          },
          {
            ...
            id: "basic",
            image: IMAGE_PATH + "/sidebar-basic.png",
          },
          {
            title: mxResources.get("arrows"),
            id: "arrows2",
            image: IMAGE_PATH + "/sidebar-arrows2.png",
          },
          {
            title: mxResources.get("clipart"),
            id: "clipart",
            image: IMAGE_PATH + "/sidebar-clipart.png",
          },
          {
        ...
        entries: [
          {
            ...
            id: "active_directory",
            image: IMAGE_PATH + "/sidebar-active_directory.png",
          },
          {
            title: mxResources.get("android"),
            id: "android",
            image: IMAGE_PATH + "/sidebar-android.png",
          },
          {
            title: "Atlassian",
            id: "atlassian",
            image: IMAGE_PATH + "/sidebar-atlassian.png",
          },
          {
          ...
          { title: "C4", id: "c4", image: IMAGE_PATH + "/sidebar-c4.png" },
          {
            ...
            id: "dfd",
            image: IMAGE_PATH + "/sidebar-dfd.png",
          },
          {
            title: mxResources.get("entityRelation"),
            id: "er",
            image: IMAGE_PATH + "/sidebar-er.png",
          },
          {
            title: mxResources.get("ios"),
            id: "ios",
            image: IMAGE_PATH + "/sidebar-ios.png",
          },
          {
            title: mxResources.get("mockups"),
            id: "mockups",
          ...
          },
          {
            title: "Sitemap",
            id: "sitemap",
            image: IMAGE_PATH + "/sidebar-sitemap.png",
          },
          {
          ...
          {
            title: mxResources.get("uml"),
            id: "uml",
            image: IMAGE_PATH + "/sidebar-uml.png",
          },
        ],
      },

      {
        ...
        entries: [
          ...
          {
            title: mxResources.get("archiMate21"),
            id: "archimate",
            image: IMAGE_PATH + "/sidebar-archimate.png",
          },
          {
            title: mxResources.get("bpmn") + " 2.0",
            id: "bpmn2",
            image: IMAGE_PATH + "/sidebar-bpmn.png",
          },
          {
            title: mxResources.get("sysml"),
            id: "sysml",
            image: IMAGE_PATH + "/sidebar-sysml.png",
          },
          {
            title: "Value Stream Mapping",
            id: "lean_mapping",
            image: IMAGE_PATH + "/sidebar-leanmapping.png",
          },
        ],
      },
      {
        ...
        entries: [
          {
            title: mxResources.get("cabinets"),
            id: "cabinets",
            image: IMAGE_PATH + "/sidebar-cabinets.png",
          },
          {
            title: "Infographic",
            id: "infographic",
            image: IMAGE_PATH + "/sidebar-infographic.png",
          },
          {
            title: mxResources.get("eip"),
            id: "eip",
            image: IMAGE_PATH + "/sidebar-eip.png",
          },
          {
          ...
          {
            title: mxResources.get("floorplans"),
            id: "floorplan",
            image: IMAGE_PATH + "/sidebar-floorplans.png",
          },
          {
            title: "Fluid Power (ISO 1219)",
            id: "fluid_power",
            image: IMAGE_PATH + "/sidebar-fluid_power.png",
          },
          {
            title: mxResources.get("gmdl"),
            id: "gmdl",
          ...
          },
          {
            ...
            id: "threatModeling",
            image: IMAGE_PATH + "/sidebar-threatmodeling.png",
          },
          {
            title: "Web Icons",
            id: "webicons",
            image: IMAGE_PATH + "/sidebar-webIcons.png",
          },
          {
            title: mxResources.get("signs"),
            id: "signs",
            image: IMAGE_PATH + "/sidebar-signs.png",
          },
        ],
      },
    ];
        ...
        mxUtils.bind(this, function (evt) {
          if (mxEvent.getSource(evt).nodeName == "BUTTON") {
            ...
            var doc = parser.parseFromString(
              '<body style="background:#ffffff;font-family:Helvetica,Arial;">' +
                title2.outerHTML +
                clone.outerHTML +
                "</body>",
              "text/html"
                  ...
                  mxUtils.bind(this, function () {
                    new mxXmlRequest(
                      ...
                      "w=456&h=" +
                        h +
                        "&html=" +
                        encodeURIComponent(Graph.compress(html))
    ...
    for (var i = 0; i < lines.length; i++) {
      if (lines[i] != null) {
        ...
        if (tags.length > 1) {
          ...
          var value = mxUtils.trim(
            tags.slice(1, tags.length).join(" ").toLowerCase()
          );
              ...
              for (var i = 0; i < libs.length; i++) {
                mxUtils.bind(this, function (lib) {
                  ...
                  if (config != null) {
                    this.showPalettes(
                      config.prefix || "",
                      config.libs || [config.id],
                      true
                    );
                    var elts = this.showPalette(
  ...
  Sidebar.prototype.initPalettes = function () {
          ...
          for (var k = 0; k < entry.libs.length; k++) {
            mxUtils.bind(this, function (lib) {
              ...
              if (
                ...
                lib.url != null &&
                !lib.preload &&
                preloadCount >= this.maxPreloadCount
              ) {
                this.addPalette(
                  entry.id + "." + k,
    ...
    if (this.createdSearchIndex != null) {
      console.log(
        "searchFileData",
        Graph.compress(JSON.stringify(this.createdSearchIndex))
      );
    }
  };
      ...
      mxStencilRegistry.loadStencilSet(
        ...
        mxUtils.bind(
          ...
          function (packageName, stencilName, displayName, w, h) {
            if (
              (this.createdSearchIndex != null && ignore == null) ||
              mxUtils.indexOf(ignore, stencilName) < 0
            ) {
              var entry = {
          ...
          results.push(
            mxUtils.bind(this, function () {
              return this.createVertexTemplate(
                "shape=image;html=1;verticalAlign=top;" +
                    ...
                    if (req.getText() != null && req.getText().length > 0) {
                      try {
                        ...
                        if (res == null || res.icons == null) {
                          ...
                          succ(
                            results,
                            (page - 1) * count + results.length,
                            res.icons.length == count,
                            terms
                          );
                        }
                      } catch (e) {
  ...
  Sidebar.prototype.itemClicked = function (cells, ds, evt) {
    ...
    if (
      ...
      if (
        graph.getModel().isEdge(graph.getSelectionCell()) &&
        graph.getModel().getTerminal(graph.getSelectionCell(), false) == null &&
        ...
        try {
          ...
          if (evt == null || !mxEvent.isShiftDown(evt)) {
            graph.fireEvent(
              new mxEventObject("cellsInserted", "cells", [target])
            );
          }
        } catch (e) {
          this.editorUi.handleError(e);
